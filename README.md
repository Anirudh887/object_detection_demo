...
```
https://github.com/Anirudh887/object_detection_demo
```
...
### Step 2: Open [Colab notebook](https://colab.research.google.com/github/Anirudh887/object_detection_demo/blob/master/tensorflow_object_detection_training_colab.ipynb)
...
You can also opt to download my [copy](https://github.com/Anirudh887/object_detection_demo/releases/download/V0.1/checkpoint.zip) of those files from the GitHub Release page.
